// ======================================================================
// NixieClock.v generated from TopDesign.cysch
// 10/15/2019 at 09:47
...
module SW_Tx_UART_v1_50_5 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("90d9b26a-db7f-4e60-8795-5126bea7a15a/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("509cf111-9919-485f-b4df-d5fcd8d1f35a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("cb202c07-9d84-401f-87fc-974cfd2e10fa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("aafee11a-5350-4dbe-9eb5-94701d01f433"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9aae2a75-aad9-41cb-8439-fde39b497c49"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LD_net;
	wire [0:0] tmpFB_0__LD_net;
	wire [0:0] tmpIO_0__LD_net;
	wire [0:0] tmpINTERRUPT_0__LD_net;
	electrical [0:0] tmpSIOVREF__LD_net;

	cy_psoc3_pins_v1_10
		#(.id("44a5ce5f-506c-4f71-bfd6-dc0761771822"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		LD
		 (.oe(tmpOE__LD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LD_net[0:0]}),
		  .io({tmpIO_0__LD_net[0:0]}),
		  .siovref(tmpSIOVREF__LD_net),
		  .interrupt({tmpINTERRUPT_0__LD_net[0:0]}),
		  .annotation({Net_73}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("e22a242d-e37c-40a8-ac6a-8eee5e81ece6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__ADC0_net;
	wire [0:0] tmpFB_0__ADC0_net;
	wire [0:0] tmpIO_0__ADC0_net;
	wire [0:0] tmpINTERRUPT_0__ADC0_net;
	electrical [0:0] tmpSIOVREF__ADC0_net;

	cy_psoc3_pins_v1_10
		#(.id("b1c65051-9774-44d5-8c6c-e85e48626ed1"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ADC0
		 (.oe(tmpOE__ADC0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC0_net[0:0]}),
		  .analog({Net_286}),
		  .io({tmpIO_0__ADC0_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC0_net),
		  .interrupt({tmpINTERRUPT_0__ADC0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADC0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
